      ...
      <div className="contact-main">
        ...
        <div className="basic-contact">
          <Fade bottom duration={1000} distance="40px">
              ...
              <div className="contact-heading-text-div">
                ...
                >
                  <li>
                    ...
                    <strong>Birthday:</strong> <span>Sept 17 2006</span>
                  </li>
                  <li>
                    <i class="bi bi-chevron-right"></i> <strong>Phone:</strong>{" "}
                    <span>+66 083-651-6651</span>
                  </li>
                  <li>
                    <i class="bi bi-chevron-right"></i> <strong>City:</strong>{" "}
                    <span>Hatyai, Songkhla, Thailand</span>
                  </li>
                  <li>
                    <i class="bi bi-chevron-right"></i>{" "}
                    <strong>Nationality:</strong> <span>Thai</span>
                  </li>
                  <li>
                    <i class="bi bi-chevron-right"></i>{" "}
                    <strong>Religion:</strong> <span>Buddhist</span>
                  </li>
                  <li>
                    <i class="bi bi-chevron-right"></i>{" "}
                    <strong>Programming languages:</strong>{" "}
                    <span>C++, C#, Python, Some Javascript</span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span>jirakorn.sukmee@gmail.com</span>
                  </li>
                  <li>
                    <i class="bi bi-chevron-right"></i>{" "}
                    <strong>Hobbies:</strong>{" "}
                    <span>Projects, Reading, Coding</span>
                  </li>
                  <li>
                    <i class="bi bi-chevron-right"></i>{" "}
                    <strong>Talents:</strong>{" "}
                    <span>
                      Reading/Speaking English, CAD Designs, Circuit Designs
                    </span>
                  </li>
                  <li>
                    <i class="bi bi-chevron-right"></i>{" "}
                    <strong>Interests:</strong>{" "}
                    <span>Engineering, Robotics, Electrical Circuits</span>
                  </li>
                </p>
              </div>
            </div>
            ...
            >
              Aspiring engineer.
              ศึกษาอยู่ที่โรงเรียนหาดใหญ่วิทยาลัยในห้องเรียนพรีเมียมวิทยาศาสตร์
              เทคโนโลยี และออกแบบสถาปัตย์ มีความสนใจอย่างสูงในด้านวิศวกรรมไฟฟ้า
              วิศวกรรมแมคคาทรอนิกส์ และหุ่นยนต์
              มีความสามารถในการใช้งานและออกแบบโปรแกรม Fusion 360
              มีความรู้ในการออกแบบและทำโปรเจกต์เล็กๆ
              จนถึงโปรเจกต์ใหญ่ที่กำลังพัฒนาอย่างต่อเนื่อง
            </p>
          </Fade>
        </div>
        <Fade bottom duration={1000} distance="40px">
          <div className="basic-contact">
            ...
            <div className="skill-box">
              <span className="contact-header-detail-text subTitle">
                Fusion 360
              </span>
